...
let lastNames = ['Avey', 'Crofoot', 'Flor', 'Barletta', 'Zoller', 'Rosson', 'Coomes', 'Wilken', 'Withey', 'Ojeda', 'Mennella', 'Gauer', 'Puccio', 'Zimmerer', 'Cottrell', 'Bridgman', 'Gershman', 'Tinoco', 'Ayoub', 'Fournier', 'Marcella', 'Melrose', 'Lafontaine', 'Cathcart', 'Cioffi', 'Sands', 'Lei', 'Cardoso', 'Dela', 'Metcalfe', 'Ethridge', 'Fryer', 'Warden', 'Madson', 'Gonsales', 'Tobey', 'Knecht', 'Gallion', 'Thibault', 'Brockington', 'Baney', 'Haddox', 'Kang', 'Galyean', 'Riccio', 'Lake', 'Mirabella', 'Frechette', 'Rearick', 'Carmouche']
let loremIpsum = [
...
function makePoster(color: string) {
    ...
    let ctxt = _canvas.getContext('2d')
...
let posters = posterColors.map(function (color: number[]) {
...
function genArray( minLength: number, maxLength: number, genElement: any ) {
